...
### Algorithm:
1.Create a stack using LifoQueue(maxsize=7).

2.Read n from the user and take n inputs to push to the stack.

3.Check stack.full() and display the result.

4.Use stack.get() in a loop to print elements in reverse order.
...
```
### Output:
![image](https://github.com/user-attachments/assets/699aa3c5-9856-477c-9139-e802dc715c67)
